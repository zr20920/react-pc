...
import AddClassHourModal from '@/pages/CourseCenter/addClassHourModal'
import EditClassHourModal from '@/pages/CourseCenter/editClassHourModal'
import AddChapterModal from '@/pages/CourseCenter/addChapterModal'
